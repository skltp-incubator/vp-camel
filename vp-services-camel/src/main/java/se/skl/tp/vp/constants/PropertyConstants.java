...
public class PropertyConstants {
    ...
    public static final String VP_PLATFORM_ID = "vp.platform.id";

    public static final String USE_HEADER_X_VP_AUTH_DN_TO_RETRIEVE_SENDER_ID = "use.header.x-vp-auth-DN.to.retrieve.sender.id";
