...
public class HttpHeaders {
	...
	private static final Set<String> ALL_HEADERS=new HashSet();

	private static String add2All(String pHeader){
		ALL_HEADERS.add(pHeader);
		return pHeader;
	}

	public static Set<String> getAllHeaders(){
		return ALL_HEADERS;
	}
	/**
	 ...
	 * @since VP-2.2.1
	 */
	public static final String X_SKLTP_PRODUCER_RESPONSETIME = add2All("x-skltp-prt");
	/**
	 ...
	 * @since VP-2.2.12
	 */
	public static final String X_SKLTP_CORRELATION_ID = add2All("x-skltp-correlation-id");
	/**
	 ...
	 * @since VP-2.0
	 */
	public static final String X_RIVTA_ORIGINAL_SERVICE_CONSUMER_HSA_ID = add2All("x-rivta-original-serviceconsumer-hsaid");
	/**
	 ...
	 * @since VP-2.2.3
	 */
	public static final String X_VP_SENDER_ID = add2All("x-vp-sender-id");
	/**
	 ...
	 * @since VP-2.2.4
	 */
	public static final String X_VP_INSTANCE_ID = add2All("x-vp-instance-id");
	/**
	 * Incoming HTTP Header x-vp-auth-cert, carrying a X509 certificate, used when implementing a reverse proxy.
	 *
	 * @since VP-1.3
	 */
	public static final String REVERSE_PROXY_HEADER_NAME = add2All("x-vp-auth-cert");
	
	/**
	 * User-Agent for outgoing requests from VP
	 * TODO: Make this configurable rather than a static variable.
	 */
	public static final String VP_HEADER_USER_AGENT = add2All("SKLTP VP/3.1");
